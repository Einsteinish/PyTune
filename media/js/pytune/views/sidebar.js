PYTUNE.Views.Sidebar = Backbone.View.extend({
    ...
    check_river_blurblog_collapsed: function(options) {
        ...
        var collapsed = _.contains(PYTUNE.Preferences.collapsed_folders, 'river_blurblog');
    ...
    show_collapsed_river_blurblog_count: function(options) {
        options = options || {};
        var $header = PYTUNE.reader.$s.$river_blurblogs_header;
    ...
    collapse_river_blurblog: function(e, options) {
        ...
        if (options.force_collapse || 
            ...
            PYTUNE.assets.collapsed_folders('river_blurblog', true);
            $header.addClass('NB-folder-collapsed');
        ...
        // Showing / Expanding
                 ...
                 (!$folder.eq(0).is(':visible'))) {
            PYTUNE.assets.collapsed_folders('river_blurblog', false);
    ...
    open_river_blurblogs_stories: function() {
        return PYTUNE.reader.open_river_blurblogs_stories();
    },
    
    open_river_global_stories: function() {
        return PYTUNE.reader.open_river_blurblogs_stories({'global': true});
    }
