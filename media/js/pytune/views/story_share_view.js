PYTUNE.Views.StoryShareView = Backbone.View.extend({
    ...
    mark_story_as_shared: function(options) {
        ...
        if (this.options.on_social_page) {
            var source_user_id = PYTUNE.Globals.blurblog_user_id;
        } else if (_.contains(['river:blurblogs', 'river:global'], PYTUNE.reader.active_feed)) {
        ...
        var data = {
            ...
            relative_user_id: PYTUNE.Globals.blurblog_user_id,
