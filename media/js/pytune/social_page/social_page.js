PYTUNE.Views.SocialPage = Backbone.View.extend({
    ...
    follow_user: function() {
        ...
        PYTUNE.assets.follow_user(PYTUNE.Globals.blurblog_user_id, _.bind(function(data) {
            var message = 'You are now following ' + PYTUNE.Globals.blurblog_username;
            if (data.follow_profile.requested_follow) {
                message = 'Your request to follow ' + PYTUNE.Globals.blurblog_username + ' has been sent';
            }
    ...
    unfollow_user: function() {
        ...
        PYTUNE.assets.unfollow_user(PYTUNE.Globals.blurblog_user_id, _.bind(function(data) {
            $button.html('Follow ' + PYTUNE.Globals.blurblog_username).removeClass('NB-button-following')
